...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  //TODO: Have a look at the iat properti
...
exports.isLoggedIn = async (req, res, next) => {
  ...
  if (req.cookies.jwt) {
    try {
      ...
      res.locals.user = freshUser; // Each pug template will have access to res.locals
    } catch (error) {
      return next();
    }
  }
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // 3) Update password if the password is correct
  user.password = req.body.password;
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
