...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGVjdG9yZzIyMTEiLCJhIjoiY2t0eWtxbmhtMDhwMTJwcG1jZXd0b3VhMSJ9.8XhBErdMP3PqsR-xN-NkMA';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // Extend map bounds to incude the current location
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "D:\\Héctor\\JavaScript\\Node JS\\4-natours\\starter",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51Jfr1nGi4Mxbt8fRqFOVfXLsyooWN9tKcySTsmX46XLfKBYLCb60owwJGMlBNF1Ihd9ApO3GBpNStosQhZUxjZuH00yf0yqv8k'); // 1) Get checkout session from API
